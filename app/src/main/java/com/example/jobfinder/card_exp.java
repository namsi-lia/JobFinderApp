...
public class card_exp extends RecyclerView.Adapter<card_exp.newMyViewHolder> {
  ...
  @NonNull
    ...
    @Override
    public  void onBindViewHolder(final newMyViewHolder holder, int position) {
        ...
        holder.card_exper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("jobtitle",jobtitle.get(holder.getAdapterPosition()));
                intent.putExtra("company",company.get(holder.getAdapterPosition()));
