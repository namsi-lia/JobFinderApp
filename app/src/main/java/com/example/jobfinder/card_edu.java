...
public class card_edu extends RecyclerView.Adapter<card_edu.neMyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final card_edu.neMyViewHolder holder, int position) {
        final String card_deg = (String) degree.get(position);
        ...
        holder.card_edu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("degree", degree.get(holder.getAdapterPosition()));
                intent.putExtra("field of study", fos.get(holder.getAdapterPosition()));
